...
__device__ float compress_symbolic_block_for_partition_1plane(block_size_descriptor* bsd, uint32_t partition_count, unsigned int partition_index)
{
	partition_info* pi = get_partition_info(bsd,partition_count, partition_index);
